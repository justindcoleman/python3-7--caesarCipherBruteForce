...
def dictionary(): # this builds a list out of the dictionary file, dictionary.txt <- **needs to be located in same dir
...
def isEnglish(candidateText, totalNumberOfWords):
